...
public class Edicao extends ListaPagar{
	...
	private void initialize() {
		...
		textField.setText(p.getData());
		textField_2.setText(p.getObservacao());
		textField_1.setText(String.valueOf(p.getValor()));
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				pagar.setData(textField.getText());
				pagar.setValor(Double.parseDouble(textField_1.getText()));
				pagar.setObservacao(textField_2.getText());
				dao.editarpagar(pagar);
